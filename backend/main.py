...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "https://nano-predict-git-main-vortex-5d1a.vercel.app",
    ],
    allow_origin_regex=r"https://nano-predict-[a-z0-9-]+-vortex-5d1a\.vercel\.app",
    ...
    try:
        ...
        while True:
            ...
            if not isinstance(data, dict):
                print("[Hardware] Invalid packet received")
                continue

            hardware_telemetry.update(data)
